  ...
  try {
    ...
    if (subtasks.length > 0) {
      ...
      for (const subtask of subtasks) {
        ...
        // Note: For "today" mode, if lastScheduledEnd is after today, the scheduler will handle it
      ...
      return NextResponse.json({
        ...
        shuffledTasks,
        feedback,
        message: `Scheduled ${scheduledSubtasks.length} of ${subtasks.length} subtasks for today`,
      });
    }
